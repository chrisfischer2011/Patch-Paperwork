...
class NewProjectTab(ctk.CTkFrame):
    ...
    def on_double_click(self, event):
        ...
        def save_edit(event=None):
            ...
            # Optional: Update SQLite backend immediately
    ...
    def update_rack_in_db(self, item_id, col_name, new_value):
        """Sync edit back to SQLite (basic version)"""
        try:
            row_id = self.tree.index(item_id)   # 0-based index
            # For full sync later we can expand this
            pass  # We'll improve this in next step if needed
        except:
            pass
